...
//        System.out.println("agent0 id is "+ properties.getAppConfigs().get(0).getAgentId());
//        System.out.println("the agent0 token is " + properties.getAppConfigs().get(0).getToken());
    }
